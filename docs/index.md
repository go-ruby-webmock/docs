# go-ruby-webmock documentation

**Pure-Go WebMock: HTTP request stubbing/matching, CGO=0 — bound into rbgo**

`go-ruby-webmock/webmock` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `webmock`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `webmock`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`webmock`](https://github.com/go-ruby-webmock/webmock) | the library — Ruby's `webmock` in pure Go |
| [`docs`](https://github.com/go-ruby-webmock/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-webmock.github.io`](https://github.com/go-ruby-webmock/go-ruby-webmock.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-webmock/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-webmock/webmock](https://github.com/go-ruby-webmock/webmock).
